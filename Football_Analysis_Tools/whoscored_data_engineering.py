        ...
        for team in set(match_events['teamId']):
            ...
            if event_team == 'own':
                team_events = match_events[(match_events['teamId'] == team) &
                                           (match_events['event_type'] == event_name)]
...
def find_offensive_actions(events_df):
    ...
    offensive_actions = ['TakeOn', 'Pass', 'MissedShots', 'SavedShot', 'Goal', 'Carry']
...
def find_defensive_actions(events_df):
    ...
    defensive_actions = ['BallRecovery', 'BlockedPass', 'Challenge', 'Clearance', 'Interception', 'Tackle',
                         'Claim', 'KeeperPickup', 'Punch', 'Save', 'Aerial','Foul','ShieldBallOpp','Dispossessed']
